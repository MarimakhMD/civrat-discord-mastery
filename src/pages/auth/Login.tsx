      ...
      <div className="relative z-10 min-h-[80vh] flex items-center justify-center px-4">
        <motion.div className="w-full max-w-md" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="card border-neon-green/30">
            ...
            <button type="button" onClick={() => void login()} className="btn-primary w-full flex items-center justify-center gap-3 py-3">
            ...
            <p className="mt-5 text-center text-xs text-dark-300">A session Discord active est requise pour accéder au dashboard.</p>
          </div>
